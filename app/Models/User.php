...
class User extends Authenticatable implements MustVerifyEmail
{
     ...
     */
    protected $fillable = [
        'name', 'email', 'password', 'address', 'city', 'postal_code', 'phone', 'country', 'provider_id', 'email_verified_at', 'verification_code', 'is_guest', 'account_claimed_at'
    ];
    ...
    public function guestCheckoutSessions()
    {
        return $this->hasMany(GuestCheckoutSession::class, 'guest_user_id');
    }
