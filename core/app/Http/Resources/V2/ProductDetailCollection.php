        ...
        return [
            'data' => $this->collection->map(function ($data) {
                ...
                return [
                    ...
                    'compare_at_price' => (float) number_format((float) explode('-', home_base_price($data, false))[0], $precision, '.', ''),
                    ...
                    'brand' => $brand,
                    'link' => storefront_url('products/' . $data->slug),
                    ...
                    'custom_labels' => json_decode($data->custom_labels) ?? [],
