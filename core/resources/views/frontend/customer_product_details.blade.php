                            ...
                            @if ($customer_product->photos != null)
                                ...
                                <div class="col-12">
                                    <div class="aiz-carousel product-gallery arrow-lg-none" data-nav-for='.product-gallery-thumb' data-fade='true' data-auto-height='true'  data-arrows='true'>
                                        ...
                                        <div class="carousel-box img-zoom rounded-0 lightbox-item">
                                            <img class="img-fluid h-auto lazyload mx-auto lightbox-source"
                                            ...
                                            <div class="wd-show-product-gallery-wrap m-2">
                                                <a href="#" class="woodmart-show-product-gallery">
                                                    <span class="pt-1"><i class="las la-expand-arrows-alt fs-24 ml-1"></i></span>
