<div class="carousel-box h-100 text-center has-transition hov-animate-outline-2">
    <div class="px-3 px-xl-2 py-2 ">
        ...
        <!-- Shop name -->
        <h2 class="fw-400 fs-13 text-truncate-2 lh-1-4 mb-0 h-35px text-center mt-1">
            <a href="{{ route('preorder-product.details', $product->product_slug) }}"
