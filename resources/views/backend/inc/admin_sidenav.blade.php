<div class="aiz-sidebar-wrap">
        ...
        <div class="aiz-side-nav-wrap">
            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                ...
                @if (addon_is_activated('preorder'))
                    @canany([
                        'preorder_dashboard',
                        'add_preorder_product',
                        'view_all_preorder_products',
                        'view_all_preorders',
                        'view_all_inhouse_preorders',
                        'view_all_seller_preorders',
                        'view_all_delayed_prepayment_preorders',
                        'view_all_final_preorders',
                        'view_preorder_seller_commission_history',
                        'preorder_settings',
                        'view_all_preorder_product_conversations',
                        'view_all_preorder_product_queries',
                        'view_all_preorder_product_reviews',
                        'view_all_faqs',
                        'view_all_preorder_notification_types'
                    ])
                        <li class="aiz-side-nav-item">
                            <a href="#" class="aiz-side-nav-link">
                                <div class="aiz-side-nav-icon">
 ...
 <!-- Refund addon -->
                        ...
                        <li class="aiz-side-nav-item">
                            ...
                            <ul class="aiz-side-nav-list level-2">
                                @can('view_all_seller')
                                    <li class="aiz-side-nav-item">
                                        @php
                                            $sellers = \App\Models\Shop::where('verification_status', 0)->where(
                                                'verification_info',
                                                '!=',
                                                null
                                            )->count();
                ...
                @canany([
                        ...
                        'african_pg_configuration',
                        'african_pg_credentials_configuration',
                        'view_all_manual_payment_methods',
                                ...
                                @canany([
                                    ...
                                    <li class="aiz-side-nav-item">
                                        ...
                                        <ul class="aiz-side-nav-list level-3">
                                            ...
                                            @if(
                                                    get_setting('classified_product') == 1 &&
