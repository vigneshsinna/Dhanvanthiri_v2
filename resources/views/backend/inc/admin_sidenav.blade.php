<div class="aiz-sidebar-wrap">
        ...
        <div class="aiz-side-nav-wrap">
            <div class="px-3 mb-3 position-relative">
                <input class="form-control bg-transparent rounded-2 form-control-sm text-white fs-14" type="text"
                    ...
                    aria-label="{{ translate('Search navigation menu') }}">
                <span class="absolute-top-right pr-3 mr-3 mt-2">
            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                ...
                <li class="aiz-side-nav-item">
                    <a href="#" class="aiz-side-nav-link">
                        <div class="aiz-side-nav-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="#575b6a"><path d="M4 6H2v14c0 1.1.9 2 2 2h14v-2H4V6zm16-4H8c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm-1 9H9V9h10v2zm-4 4H9v-2h6v2zm4-8H9V5h10v2z"/></svg>
                        </div>
                        ...
                        <ul class="aiz-side-nav-list level-2">
                                ...
                                <ul class="aiz-side-nav-list level-3">
                                    <li class="aiz-side-nav-item">
                                        <a href="{{ route('products.seller','all') }}" class="aiz-side-nav-link {{ areActiveRoutes(['products.seller.edit']) }}">
                                            <span class="aiz-side-nav-text">{{translate('Seller: All Products')}}</span>
                                        </a>
                                    </li>
                                    <li class="aiz-side-nav-item">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{route('categories_wise_product_discount')}}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{translate('Category Discount')}}</span>
                                </a>
                            </li>
                            @endcan
                                ...
                                @can('preorder_dashboard')
                                    <li class="aiz-side-nav-item">
                                        <a href="{{route('preorder.dashboard')}}" class="aiz-side-nav-link">
                                            <span class="aiz-side-nav-text">{{translate('Preorder Dashboard')}}</span>
                                        </a>
                                    </li>
                                @endcan
                                            ...
                                            @can('view_all_preorders')
                                                <li class="aiz-side-nav-item">
                                                    <a href="{{ route('all_preorder.list') }}" class="aiz-side-nav-link {{ areActiveRoutes(['preorder-order.show'])}} }}">
                                                        <span class="aiz-side-nav-text">{{translate('Preorder Orders')}} <span class="badge badge-info ml-1">{{ $all_preorders_count ?: '' }}</span> </span>
                                                    </a>
                                                </li>
                                            @endcan
                ...
                <li class="aiz-side-nav-item">
                    <a href="#" class="aiz-side-nav-link">
                        <div class="aiz-side-nav-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="#575b6a"><path d="M7 18c-1.1 0-1.99.9-1.99 2S5.9 22 7 22s2-.9 2-2-.9-2-2-2zM1 2v2h2l3.6 7.59-1.35 2.45c-.16.28-.25.61-.25.96 0 1.1.9 2 2 2h12v-2H7.42c-.14 0-.25-.11-.25-.25l.03-.12.9-1.63h7.45c.75 0 1.41-.41 1.75-1.03l3.58-6.49A1.003 1.003 0 0 0 20 4H5.21l-.94-2H1zm16 16c-1.1 0-1.99.9-1.99 2s.89 2 1.99 2 2-.9 2-2-.9-2-2-2z"/></svg>
                        </div>
 ...
 <!-- Refund addon -->
                                  ...
                                  @can('set_category_wise_refund')
                                    <li class="aiz-side-nav-item">
                                        <a href="{{route('categories_wise_product_refund')}}" class="aiz-side-nav-link">
                                            <span class="aiz-side-nav-text">{{translate('Category Refund')}}</span>
                                        </a>
                                    </li>
                                @endcan
                            </ul>
                ...
                <!-- Customers & Sellers Group -->
                <li class="aiz-side-nav-item">
                    <a href="#" class="aiz-side-nav-link">
                        <div class="aiz-side-nav-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="#575b6a"><path d="M16 11c1.66 0 2.99-1.34 2.99-3S17.66 5 16 5c-1.66 0-3 1.34-3 3s1.34 3 3 3zm-8 0c1.66 0 2.99-1.34 2.99-3S9.66 5 8 5C6.34 5 5 6.34 5 8s1.34 3 3 3zm0 2c-2.33 0-7 1.17-7 3.5V19h14v-2.5c0-2.33-4.67-3.5-7-3.5zm8 0c-.29 0-.62.02-.97.05 1.16.84 1.97 1.97 1.97 3.45V19h6v-2.5c0-2.33-4.67-3.5-7-3.5z"/></svg>
                        </div>
                        <span class="aiz-side-nav-text">{{translate('Customers & Sellers')}}</span>
                        <span class="aiz-side-nav-arrow"></span>
                    </a>
                    <ul class="aiz-side-nav-list level-2">
                <!-- Customers -->
                ...
                <li class="aiz-side-nav-item">
                    <a href="#" class="aiz-side-nav-link">
                        <div class="aiz-side-nav-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="#575b6a"><path d="M18 11v2h4v-2h-4zm-2 6.61c.96.71 2.21 1.65 3.2 2.39.4-.53.8-1.07 1.2-1.6-.99-.74-2.24-1.68-3.2-2.4-.4.54-.8 1.08-1.2 1.61zM20.4 5.6c-.4-.53-.8-1.07-1.2-1.6-.99.74-2.24 1.68-3.2 2.4.4.53.8 1.07 1.2 1.6.96-.72 2.21-1.65 3.2-2.4zM4 9c-1.1 0-2 .9-2 2v2c0 1.1.9 2 2 2h1l5 3V6L5 9H4zm11.5 3c0-1.33-.58-2.53-1.5-3.35v6.69c.92-.81 1.5-2.01 1.5-3.34z"/></svg>
                        </div>
                ...
                <li class="aiz-side-nav-item">
                    <a href="#" class="aiz-side-nav-link">
                        <div class="aiz-side-nav-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="#575b6a"><path d="M3 13h8V3H3v10zm0 8h8v-6H3v6zm10 0h8V11h-8v10zm0-18v6h8V3h-8z"/></svg>
                        </div>
                ...
                <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('settings.hub') }}" class="aiz-side-nav-link {{ areActiveRoutes(['settings.hub']) }}">
                                <span class="aiz-side-nav-text">{{translate('Settings Overview')}}</span>
                            </a>
                        </li>
                    ...
                    <ul class="aiz-side-nav-list level-2">       
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('products.wholesale-hsn-gst.assigns') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{translate('GST: Wholesale Products')}}</span>
                            </a>
                        </li>
                        @endif
                        @if (addon_is_activated('preorder'))
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('products.preorder-hsn-gst.assigns') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{translate('GST: Preorder Products')}}</span>
                            </a>
                        </li>
                        @endif
                        @if (addon_is_activated('auction'))
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('products.auction-hsn-gst.assigns') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{translate('GST: Auction Products')}}</span>
                            </a>
                        </li>
                        @endif
                        @endcan
