                        ...
                        <li class="list-group-item px-0">
                            <div class="media">
                                <a class="media-left" href="#">
                                    ...
                                    @else
                                        <span class="avatar avatar-sm mr-3"><img src="{{ static_asset('assets/img/avatar-place.avif') }}"></span>
                                    @endif
                                </a>
                    ...
                    <li class="list-group-item px-0">
                        <div class="media">
                            <a class="media-left" href="#">
                                ...
                                @else
                                    <span class="avatar avatar-sm m-3"><img src="{{ static_asset('assets/img/avatar-place.avif') }}"></span>
                                @endif
                            </a>
                            <div class="media-body">
