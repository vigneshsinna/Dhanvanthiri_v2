                                ...
                                <div class="col text-center border-right border-bottom has-transition hov-shadow-out z-1">
                                    <div class="position-relative px-3" style="padding-top: 2rem; padding-bottom:2rem;">
                                        ...
                                        <div class="position-relative mx-auto size-100px size-md-120px">
                                            <a href="{{ storefront_url('shop/' . $shop->slug) }}" class="d-flex mx-auto justify-content-center align-item-center size-100px size-md-120px border overflow-hidden hov-scale-img" tabindex="0" style="border: 1px solid #e5e5e5; border-radius: 50%; box-shadow: 0px 10px 20px rgba(0, 0, 0, 0.06);">
                                        ...
                                        <h2 class="fs-14 fw-700 text-dark text-truncate-2 h-40px mt-4 mb-3">
                                            <a href="{{ storefront_url('shop/' . $shop->slug) }}" class="text-reset hov-text-primary" tabindex="0">{{ $shop->name }}</a>
                                        </h2>
                                        <!-- Shop Rating -->
                                        ...
                                        <!-- Visit Button -->
                                        <a href="{{ storefront_url('shop/' . $shop->slug) }}" class="btn-visit">
