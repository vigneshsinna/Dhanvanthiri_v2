                ...
                @foreach ($followed_sellers as $key => $followed_seller)
                    @if($followed_seller->shop !=null)
                        <div class="col border-right border-bottom p-4 has-transition hov-shadow-out z-1" id="followed_seller_{{ $followed_seller->shop->id }}">
                            <!-- Shop logo -->
                            <a href="{{ storefront_url('shop/' . $followed_seller->shop->slug) }}" class="d-flex mx-auto justify-content-center align-item-center h-130px w-130px  overflow-hidden hov-scale" tabindex="0" style="border: 1px solid #e5e5e5; border-radius: 50%; box-shadow: 0px 10px 20px rgba(0, 0, 0, 0.06);">
                            ...
                            <div class="text-center">
                                ...
                                <h2 class="fs-14 fw-700 text-dark text-truncate-2 h-40px mt-3">
                                    <a href="{{ storefront_url('shop/' . $followed_seller->shop->slug) }}" class="text-reset hov-text-primary" tabindex="0">{{ $followed_seller->shop->name }}</a>
                                </h2>
                                <!-- Shop Rating -->
                                ...
                                <!-- Visit Button -->
                                <a href="{{ storefront_url('shop/' . $followed_seller->shop->slug) }}" class="btn btn-light text-gray-dark btn-block btn-sm rounded-0 border fw-700" tabindex="0" style="padding: 0.75rem">
