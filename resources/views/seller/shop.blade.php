      ...
      <div class="row align-items-center">
        <div class="col-md-6">
            <h1 class="h3">{{ translate('Shop Settings')}}
                <span class="ml-3 fs-13">(<a href="{{ storefront_url('shop/' . $shop->slug) }}" class="btn btn-link btn-sm px-0" target="_blank">{{ translate('Visit Shop')}} <i class="las la-arrow-right"></i></a>)</span>
            </h1>
        </div>
      </div>
    </div>
                    ...
                    <div class="col-md-10">
                        <div class="custom-file mb-3">
                            <label class="custom-file-label">
                                <input type="file" data-preview="#gst_preview" class="custom-file-input preview-input" name="gstin_certificate" id="gstin_certificate"  accept=".jpg,.jpeg,.avif,.bmp,application/pdf" required @if($shop->gst_verification) disabled @endif>
